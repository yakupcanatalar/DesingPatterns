...
public class Program
{
    public static void Main()
    {
        ...
        var license4 = new MovieLicense("Matrix", now, Discount.Senior, LicenseType.TwoDays);

        PrintLicenseDetails(license3);
        PrintLicenseDetails(license4);

        var license5 = new MovieLicense("Matrix", now, Discount.Senior, LicenseType.TwoDays, SpecialOffer.TwoDaysExtension);
